...
def get_auc(dir):
    ...
    best_train_results = []
    with open(f"{dir}/gram_hf.log", "r") as file:
        data = file.readlines()
        tr_index = 0
...
if __name__ == "__main__":
    print('AUC for gram_hf:')
    get_auc('../gram_hf') # Set your local folder path where *.test_probs, *.test_set files were generated by GRAM
    print('AUC for gram_hf_no_attention:')
    get_auc('../gram_hf_no_attention')